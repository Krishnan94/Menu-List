...
class Contact extends Component {
    ...
    validate(firstname,lastname,email,telnum){
        ...
        if(this.state.touched.firstname &&  firstname.length<3){
            errors.firstname="Length of the firstname should be more than 3 characters";
        }
        else if(this.state.touched.firstname &&  firstname.length>10){
            errors.firstname="Length of the firstname should be less than 10 characters";
        }
        if(this.state.touched.lastname &&  lastname.length<3){
            errors.lastname="Length of the lastname should be more than 3 characters";
        }
        else if(this.state.touched.lastname &&  lastname.length>10){
            errors.lastname="Length of the lastname should be less than 10 characters";
        }

        const reg=/^\d+$/;
        if(this.state.touched.telnum && !reg.test(telnum)){
            errors.telnum="It should be only number";
        }
